...
implement this interface. This is the core of the Dependency Inversion
Principle applied to this project — all tools depend on this abstraction,
never on concrete SDK implementations.
"""
