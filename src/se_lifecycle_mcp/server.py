...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "software engineering build flow guided by principles from 8 major SE "
        "books (Clean Code, Pragmatic Programmer, Code Complete, Design "
        "Patterns, Refactoring, Pressman, Sommerville, and Kleppmann).\n\n"
        "PHASES (aligned with Sommerville & Pressman SDLC):\n"
