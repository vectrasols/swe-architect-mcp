...
Expanded with 4 new diagram types for comprehensive SDLC coverage:
    - use_case (Pressman Ch.7 — Analysis modeling)
    - activity (Pressman Ch.7 — Behavioral modeling)
    - class (GoF, Clean Code — OOP design)
    - component (Pressman Ch.9 — Architectural design)
"""
